...
% --- Model and Fit ---
modelFun = @(params, x) 1 ./ sqrt(1 + (params(1)*x - (params(2)./x)).^2);
...
freq_plot = linspace(min(freq_R), max(freq_R), 500)';
...
errorbar(freq_R, yData, err_amp, '.', 'MarkerSize', 25, 'DisplayName', 'Measured');
